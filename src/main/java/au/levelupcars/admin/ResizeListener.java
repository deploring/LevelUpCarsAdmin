...
/**
 * Prevents resizing a {@link Component} below its initial size. Works around {@link Window#setMinimumSize(Dimension)}
...
public class ResizeListener extends ComponentAdapter {
    ...
    /**
     * Creates a {@link ResizeListener} for the specified {@link Component}. The minimum width and height are set to the
     * current width and height of the specified {@code component}.
     *
    ...
    /**
     * Creates a {@link ResizeListener} for the specified {@link Component} with the specified minimum width and
     * height.
     *
     * @param component the {@link Component} whose resize events to track
    ...
    /**
     * Invoked when the size of the {@link Component} changes. Restores the minimum size obtained during construction if
